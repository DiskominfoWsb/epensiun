...
//				$fbkd1		= $datpiltmp->fbkd;
		...
		<form action="<?=base_URL()?>admin/pensiun/filter" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<div class="row">
		<div class="col-md-2">
...
<table id="example" class="table table-bordered table-hover">
	<thead>
		...
		<tr>
			...
			<th rowspan="2"  width="6%">Jenis Pensiun<br>Pangkat/Golongan Pensiun<br>TMT Pensiun  </th>
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $b->pensiun."<br>". $b->pangkatpens."-".$b->golrupens."<br>". $b->tmt;?></td>
			...
			<td class="ctr">
				...
				<div class="btn-group">
					...
					<br><a href="<?=base_URL()?>admin/pensiun/ver/<?=$b->id?>" class="btn-info btn-sm" title="Verifikasi">  Verifikasi</a>
			...
			<?php
				...
				?>	
					<a href="<?=base_URL()?>admin/pensiun/ver/<?=$b->id?>" class="btn-info" title="Verifikasi">  Verifikasi</a>
				</div>	
